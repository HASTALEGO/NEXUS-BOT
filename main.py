...
configurar_creador_eventos(bot)
...
def crear_panel_embed(user_id):
    ...
    if datos["duration_minutes"] is not None:
        configuracion.append(
            "**Duración:** "
            + formatear_duracion(
                datos["duration_minutes"]
            )
        )
    ...
    if datos["signup_options"]:
        ...
        for opcion in datos["signup_options"]:
    ...
    if datos["mention_roles"] is not None:

        if datos["mention_roles"]:

            menciones = " ".join(
                role.mention
                for role in datos["mention_roles"]
            )
    ...
    if datos["multiple_registrations"] is not None:
    ...
    if datos["image_url"] is not None:
...
# ===========================================================
    def __init__(self, user_id):
        ...
        if datos["duration_minutes"] is None:
        ...
        if datos["mention_roles"] is None:
        ...
        if datos["multiple_registrations"] is None:
...
async def ejecutar_flujo_creacion_evento(
    ...
    datos["duration_minutes"] = resultado
    ...
    datos["signup_options"] = resultado
